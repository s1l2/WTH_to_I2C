...
private:
	static inline void check_data_treceiver_onL_type0(uint8_t countH, uint8_t countL);
	static inline void check_data_treceiver_onL_type1(uint8_t countH, uint8_t countL);
	static inline void check_data_treceiver_onL_type2(uint8_t countH, uint8_t countL);
	static inline void check_data_treceiver_onL_type3(uint8_t countH, uint8_t countL);
